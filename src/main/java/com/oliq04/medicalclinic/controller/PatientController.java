...
import com.oliq04.medicalclinic.model.patient.command.UpdatePasswordCommand;
...
//    @ResponseStatus(HttpStatus.NO_CONTENT)
//    public void editPasswordByEmail(@Email @PathVariable String email, @Valid @RequestBody UpdatePasswordCommand command) {
